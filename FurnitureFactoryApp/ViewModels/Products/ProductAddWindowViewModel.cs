namespace FurnitureFactoryApp.ViewModels.Products {
    ...
    public class ProductAddWindowViewModel : ViewModelBase {
        public ProductAddWindowViewModel(Product product) {
            Product = product;
            Types = Type.All();
        }
        ...
        /*
         * При написании дефолтного значения тому свойству, которое есть в биндинге, автоматически будет вызываться метод ValidateFields. 
         * Поэтому, присваивать значения нужно в правильном порядке, либо делать проверку в ValidateFields на то, что поле является null.
         */
        public ObservableCollection<Type> Types { get; set; }

        public override string Title => "Добавление продукта";
        #endregion
